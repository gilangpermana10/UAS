    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item">
                    <a href="/product" class='sidebar-link active'>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="text" id="title" class="form-control" placeholder="title product" name="title"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="slug" class="form-control" placeholder="location" name="location"
                                            data-parsley-required="true" />
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="date" class="form-control" placeholder="price product" name="price"
                                            data-parsley-required="true" />
                                    </div>
                                </div>
                            </div>
